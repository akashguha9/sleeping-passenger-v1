...
- Generated (UTC): `2026-05-12T00:00:00Z`
- Repo commit: `89e718e8cf2e068f184a31310d9488298ae0580f`
...
- Pending horizon: 0  Due forward: 1  Entry-price present: 1
...
- Forward-eligible: **0 → 1** (gain 1)
- Throughput improvement score (reported, NOT a gate): 1.0
- Sprint-start reason baseline: {}
- Top missing-OHLCV scored tickers (now): [{'key': 'AAPL', 'count': 1}]
- Pending horizon: 0  Real-forward pairs: 0  Needed to 200: 200
...
- Forward-eligible: 1  Pending horizon: 0  Due now: 1
- Real-forward pairs: **0** (needed to 200: 200, attached last run: 1)
- Next horizon becomes due in: 0.0 hours (earliest close 2026-05-15T00:00:00Z)
- Brier: None  ECE: None  LogLoss: None
- Status: **INSUFFICIENT_EVIDENCE** / NO_REAL_FORWARD_PAIRS
...
- S_evidence = **0.3506**
- Components: {'source_truth_score': 0.0, 'scoring_coverage': 1.0, 'snapshot_coverage': 0.005, 'forward_eligibility_coverage': 1.0, 'outcome_coverage': 0.0, 'calibration_gate_score': 0.0, 'daily_maturation_loop_score': 1.0, 'reproducibility_score': 0.0}
