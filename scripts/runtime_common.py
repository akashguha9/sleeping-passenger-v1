...
CHESS_ARCHETYPE_REPORT_PATH = RUNTIME_DIR / "chess_archetype_report.json"
HEDGE_TRADE_ENTRY_REPORT_PATH = RUNTIME_DIR / "hedge_trade_entry_report.json"
SIGNAL_SURFACE_REPORT_PATH = RUNTIME_DIR / "signal_surface_report.json"
BOARD_CONTROL_SAFETY_REPORT_PATH = RUNTIME_DIR / "board_control_safety_report.json"
PRE_EXECUTION_SCAN_REPORT_PATH = RUNTIME_DIR / "pre_execution_scan_report.json"
CONTEXT_PROFILE_REPORT_PATH = RUNTIME_DIR / "context_profile_report.json"
INTERPRETATION_PACKET_REPORT_PATH = RUNTIME_DIR / "interpretation_packet_report.json"
INTERPRETATION_DRIFT_REPORT_PATH = RUNTIME_DIR / "interpretation_drift_report.json"
REALITY_RENDERING_REPORT_PATH = RUNTIME_DIR / "reality_rendering_report.json"
CONTEXTUAL_INTERPRETATION_REPORT_PATH = RUNTIME_DIR / "contextual_interpretation_report.json"
INTERPRETATION_FAILURE_LOG_PATH = RUNTIME_DIR / "interpretation_failure_log.jsonl"
CONTEXTUAL_INTERPRETATION_SUMMARY_PATH = RUNTIME_DIR / "contextual_interpretation_summary.json"
...
EXTREME_STATE_EVENTS_PATH = RUNTIME_DIR / "extreme_state_events.jsonl"
