# THESIS CARD — CASE STUDY: Microsoft Azure — house-layer infrastructure archetype
...
## FINAL SCORE: 1.238 / 10
Caps applied: EVIDENCE_QUALITY_CAP

## SCORE FAMILIES
- FRAMEWORK VALIDATION score: 10.0 / 10 (praise for the framework, never the trade)
- RESEARCH QUALITY score: 1.238 / 10
- INVESTABILITY SCORE: 0.0 / 10 (eligibility multiplier = 0.0)

## EVIDENCE QUALITY: 0.124 (cap = 1.24)
## CONTRADICTION: g_contra = 0.496 (for 1 / against 1 / neutral-ignored 0)
## EXPIRY: 90 days remaining (day 2464; as-of day 2374)

## NARRATIVE
Validates: house-layer detection (usage-based take-rate on ecosystem activity regardless of front-end winner) and the already-priced null.

Trigger: MVP validation: house_layer detection + forced-null construction  
Predicted direction: UP over 90d

## CAUSAL PATH
AI workload belief -> compute demand -> usage-based revenue -> segment disclosure -> already-priced check

## WHO GETS PAID
- **house**: MSFT
- **losers**: on-prem vendors
- **midstream**: AI app vendors
...
## WOULD FALSIFY
- Framework check: house-layer archetype fails to render/score
- Forced null: *Cloud growth is fully priced; house quality earns beta not alpha*
...
### Contradiction board
**FOR thesis:**
- [HARD_DATA] 10-K Intelligent Cloud segment share (operator-classified) (EDGAR 10-K, day 2200)
**AGAINST (for null):**
- [MARKET] Multiple already embeds house-layer quality (market pricing, day 2370)

### Anecdote quarantine
- none

## BINDING GATE
BindingGate = **EQS** (EQS = 0.124)
