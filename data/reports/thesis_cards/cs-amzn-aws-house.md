# THESIS CARD — CASE STUDY: Amazon AWS — house-layer infrastructure archetype (second seat)
...
## FINAL SCORE: 1.251 / 10
Caps applied: EVIDENCE_QUALITY_CAP

## SCORE FAMILIES
- FRAMEWORK VALIDATION score: 10.0 / 10 (praise for the framework, never the trade)
- RESEARCH QUALITY score: 1.251 / 10
- INVESTABILITY SCORE: 0.0 / 10 (eligibility multiplier = 0.0)

## EVIDENCE QUALITY: 0.125 (cap = 1.25)
## CONTRADICTION: g_contra = 0.499 (for 1 / against 1 / neutral-ignored 0)
## EXPIRY: 90 days remaining (day 2464; as-of day 2374)

## NARRATIVE
Validates: house-layer archetype generalizes beyond one issuer; moat-cluster top-2 aggregation must count the toll-booth thesis once, not twice.

Trigger: MVP validation: moat cluster top-2 anti-double-count  
Predicted direction: UP over 90d

## CAUSAL PATH
workload belief -> AWS usage -> take-rate revenue -> segment disclosure

## WHO GETS PAID
- **house**: AMZN (AWS)
- **losers**: own-datacenter capex
- **midstream**: SaaS on AWS
...
## WOULD FALSIFY
- Framework check: second house-layer seat breaks top-2 aggregation
- Forced null: *AWS strength is priced; the equity is a retail business with a cloud attachment*
...
### Contradiction board
**FOR thesis:**
- [HARD_DATA] 10-K AWS segment disclosure (operator-classified) (EDGAR 10-K, day 2210)
**AGAINST (for null):**
- [MARKET] Retail segment drag dominates the equity story (segment mix, day 2340)

### Anecdote quarantine
- none

## BINDING GATE
BindingGate = **EQS** (EQS = 0.125)
