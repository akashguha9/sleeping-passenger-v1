...
export default function MoltbookPage() {
  const entries = MOCK_MOLTBOOK_ENTRIES;
      ...
      <div className="bg-slate-800/60 border border-slate-700/60 rounded-lg p-5">
        ...
        <div className="grid grid-cols-2 gap-2">
          {Object.entries(categoryCounts)
            ...
            .map(([cat, count]) => (
              <div key={cat} className="flex items-center justify-between px-3 py-2 rounded bg-slate-900/40 border border-slate-700/30">
